...
<body class="dark:bg-gray-900 text-white">
    <div>
        <h1 class="mt-10 mx-auto w-fit items-center text-stone-600">Welcome To Beyar Tech Shop</h1>
        ...
        <form action="search" class="mx-auto my-8  flex w-96 justify-around items-center">
            ...
            <button class="bg-orange-400 text-gray-600 p-1 hover:bg-orange-500 text-white hover:shadow-zinc-500 hover:shadow-md  border-2 rounded border-blue-400">Search</button>
        </form>
